...
<!--   Core JS Files   -->
 ...
 <script>
   $(document).ready(function() {
     ...
     <?php if (!empty($this->session->flashdata('notification_flag')))
     {?>
     var notify = $.notify('<?php echo $this->session->flashdata('notification_msg');  ?>', { allow_dismiss: true, type: '<?php echo $this->session->flashdata('notification_type');  ?>', showProgressbar: false, });
     <?php
      unset($_SESSION['notification_flag']);
